...
public:
    OffboardController() : nh_(""),current_state(),ref_path_msg(),current_pose_msg()
    {
        ...
        current_pose_sub = nh_.subscribe<geometry_msgs::PoseStamped>("uav2/mavros/local_position/pose", 10, &OffboardController::poseCallback, this);

        set_vel_pub = nh_.advertise<geometry_msgs::TwistStamped>("/uav2/mavros/setpoint_velocity/cmd_vel", 10);
    }
